...
def extract_subject_from_bdf(local_file_path,N_S, N_B) -> tuple[Raw, str]:
...
def extract_block_data_from_subject(local_file_path:str, root_dir: str, n_s: int,datatype: str, n_b: int) -> tuple:

    # Get events
    y = load_events(root_dir, n_s, n_b)


    X = mne.read_epochs(local_file_path, verbose='WARNING')
